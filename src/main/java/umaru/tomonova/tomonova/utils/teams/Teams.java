...
public enum Teams {
    ...
    GREEN("Lime", "§a",ChatColor.GREEN , Material.LIME_BANNER, null, null, null, 0),
    AQUA("Aqua", "§b",ChatColor.AQUA , Material.LIGHT_BLUE_BANNER, null, null, null, 0),
    BLUE("Blue", "§1",ChatColor.BLUE , Material.BLUE_BANNER, null, null, null, 0),
    PINK("Pink", "§d",ChatColor.LIGHT_PURPLE , Material.PINK_BANNER, null, null, null, 0), //Light purple
    MAGENTA("Magenta", "§5",ChatColor.DARK_PURPLE , Material.MAGENTA_BANNER, null, null, null, 0), //Dark purple
    WHITE("White", "§f",ChatColor.WHITE , Material.WHITE_BANNER, null, null, null, 0),
    GRAY("Gray", "§7",ChatColor.GRAY , Material.GRAY_BANNER, null, null, null, 0);
