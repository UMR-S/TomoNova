package umaru.tomonova.tomonova.gui.opGUI.communGUI.netherGUI;
...
public enum ItemsInNether {
    ACTIVATED(Material.OBSIDIAN, "Nether activé", ChatColor.GREEN, Arrays.asList(new String[]{""}) ,1,0, true),
    DESACTIVATED(Material.OBSIDIAN, "Nether désactivé", ChatColor.RED, Arrays.asList(new String[]{""}) ,-1,0,true),
    TIME_LIMIT_ACTIVATED(Material.LIME_STAINED_GLASS, "Nether, limite de temps activé", ChatColor.GREEN, Arrays.asList(new String[]{""}) ,1,0, true),
    TIME_LIMIT_DESACTIVATED(Material.RED_STAINED_GLASS, "Nether limite de temps désactivé", ChatColor.RED, Arrays.asList(new String[]{""}) ,-1,0,false),
    ...
    ItemsInNether(Material material, String mainText, ChatColor colorMainText, List<String> subText, Integer number, Integer placeInInventory, Boolean initiallyActivated) {
