package umaru.tomonova.tomonova.gui.opGUI.communGUI.PvPGUI;
...
public enum ItemsInPvPGUI {

    ACTIVATED(Material.DIAMOND_SWORD, "Activé", ChatColor.GREEN, Arrays.asList(new String[]{""}) ,1,0, true),
    DESACTIVATED(Material.DIAMOND_SWORD, "Désactivé", ChatColor.RED, Arrays.asList(new String[]{""}) ,-1,0,false),
    ...
    ItemsInPvPGUI(Material material, String mainText, ChatColor colorMainText, List<String> subText, Integer number, Integer placeInInventory, Boolean initiallyActivated) {
